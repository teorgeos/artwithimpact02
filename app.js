...
const PAGES = [
  {
    ...
    sentences: [
  "강제 동원된 여성들은 도착 직후 군 위안소로 강제로 배치된 것으로 확인됐다.",
"위안소 내부에는 일본군 병사들이 줄을 서서 순번을 기다리고 있었으며,",
"좁고 허름한 방 구조 속에서는 도망치는 것이 사실상 불가능했다.",
"피해자들은 저항할 경우 무차별적인 폭행과 협박을 당한 것으로 조사됐다.",
"지시에 불응한 피해자들은 반복적으로 심각한 구타를 당한 것으로 알려졌다.",
"일부 피해자는 몸에 칼자국과 상처가 남을 정도로 심각한 피해를 입은 것으로 전해졌다.",
"피해자들이 지낸 위안소는 매우 열악한 환경으로, 하루에도 수십 명의 병사를 상대해야 했다.",
"피해자들은 제대로 된 치료조차 받지 못한 채 지속적으로 폭력에 노출된 것으로 드러났다.",
// "정부는 현재 피해자들이 피해 사실을 공식적으로 신고할 수 있도록 제도를 운영하고 있다."
    ],
    distort: { index: 3, text: "일본군 위안소에서 일어난 일들은 모두 자발적으로 합의 하에 이루어졌다." } // 7번째 왜곡
  },
  // {
